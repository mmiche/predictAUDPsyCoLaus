...
```{r chunk01, echo=TRUE, eval = FALSE}
...
# https://github.com/mmiche/mysml   (Download code - copy paste from this URL)
...
There exists an alternative to k-fold cross-validation, which makes use of the full data. This bootstrapping alternative is described in Box 1 of Riley and Collins (2023), and in Box 2 of Collins et al. (2024). The procedure is implemented in the R package pminternal (Rhodes, Version 0.0.1). The main advantage of this approach is that the user receives an estimate of the overoptimism of the apparent prediction performance ('apparent' performance is the results, when using the same dataset for training as well as for testing the prediction model).
...
```{r chunk29, echo=TRUE, eval = FALSE}
...
other attached packages:
 ...
 [5] rms_8.0-0                  Hmisc_5.2-3               
 [7] ClinicalUtilityRecal_0.1.0 pminternal_0.0.1          
 [9] pmcalibration_0.2.0        gridExtra_2.3             
[11] cowplot_1.1.3              ggplot2_3.5.2             
[13] mysml_0.1.0                ranger_0.17.0             
[15] tidyr_1.3.1                magrittr_2.0.3            
[17] dplyr_1.1.4               

loaded via a namespace (and not attached):
  [1] mnormt_2.1.1         Rdpack_2.6.4         pbapply_1.7-2       
  [4] pROC_1.18.5          sandwich_3.1-1       rlang_1.1.6         
  [7] multcomp_1.4-28      polspline_1.1.25     compiler_4.4.0      
 [10] vctrs_0.6.5          reshape2_1.4.4       RcppZiggurat_0.1.6  
 [13] quantreg_6.1         stringr_1.5.1        pkgconfig_2.0.3     
 [16] fastmap_1.2.0        backports_1.5.0      rmarkdown_2.29      
 [19] prodlim_2025.04.28   nloptr_2.2.1         MatrixModels_0.5-4  
 [22] purrr_1.0.4          Rfast_2.1.0          xfun_0.52           
 [25] recipes_1.3.0        psych_2.4.6.26       parallel_4.4.0      
 [28] cluster_2.1.6        R6_2.6.1             stringi_1.8.7       
 [31] RColorBrewer_1.1-3   parallelly_1.44.0    rpart_4.1.23        
 [34] lubridate_1.9.4      Rcpp_1.0.14          iterators_1.0.14    
 [37] knitr_1.50           future.apply_1.11.3  zoo_1.8-14          
 [40] base64enc_0.1-3      Matrix_1.7-0         splines_4.4.0       
 [43] nnet_7.3-19          timechange_0.3.0     tidyselect_1.2.1    
 [46] rstudioapi_0.17.1    dichromat_2.0-0.1    yaml_2.3.10         
 [49] timeDate_4041.110    doParallel_1.0.17    codetools_0.2-20    
 [52] listenv_0.9.1        lattice_0.22-6       tibble_3.2.1        
 [55] plyr_1.8.9           GLDEX_2.0.0.9.3      withr_3.0.2         
 [58] evaluate_1.0.3       foreign_0.8-86       future_1.49.0       
 [61] survival_3.5-8       RcppParallel_5.1.10  fitdistrplus_1.2-2  
 [64] pillar_1.10.2        rsconnect_0.8.26     checkmate_2.3.2     
 [67] foreach_1.5.2        stats4_4.4.0         generics_0.1.4      
 [70] scales_1.4.0         globals_0.18.0       class_7.3-22        
 [73] CalibratR_0.1.2      glue_1.8.0           tools_4.4.0         
 [76] data.table_1.17.2    SparseM_1.84-2       ModelMetrics_1.2.2.2
 [79] gower_1.0.2          forcats_1.0.0        mvtnorm_1.3-3       
 [82] grid_4.4.0           rbibutils_2.3        wesanderson_0.3.7   
 [85] ipred_0.9-15         colorspace_2.1-1     patchwork_1.3.0     
 [88] nlme_3.1-164         RNGforGPD_1.1.0      htmlTable_2.4.3     
 [91] spacefillr_0.3.3     Formula_1.2-5        cli_3.6.5           
 [94] gp_1.1               lava_1.8.1           corpcor_1.6.10      
 [97] ggcorrplot_0.1.4.1   gtable_0.3.6         digest_0.6.37       
[100] caret_7.0-1          TH.data_1.1-3        htmlwidgets_1.6.4   
[103] farver_2.1.2         htmltools_0.5.8.1    lifecycle_1.0.4     
[106] hardhat_1.4.1        MASS_7.3-60.2
```
