...
### Packages that will automatically be installed:
...
These four packages are not obligatory for the use of this 'predictAUDPsyCoLaus' package. However, if all of the vignette code shall be executed, then these packages must be installed:
...
loaded via a namespace (and not attached):
 ...
 [93] pminternal_0.1.1           lava_1.8.1                
