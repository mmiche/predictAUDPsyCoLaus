...
For installation details of the following packages, e.g., to copy and paste package installation code, see **Info** on the [predictAUDPsyCoLaus GitHub page](https://github.com/mmiche/predictAUDPsyCoLaus).
