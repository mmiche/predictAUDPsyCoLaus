...
# Original study code start

# Content:
# 1. Compute net benefit and visualize the results.
# 2. Compute calibration and visualize the results.
# 3. Compute discrimination and visualize the results.
