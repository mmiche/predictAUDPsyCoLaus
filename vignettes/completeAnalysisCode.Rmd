...
There exists an alternative to k-fold cross-validation, which makes use of the full data. This bootstrapping alternative is described in Box 1 of Riley and Collins (2023), and in Box 2 of Collins et al. (2024). The procedure is implemented in the R package pminternal (Rhodes, Version 0.1.1). The main advantage of this approach is that the user receives an estimate of the overoptimism of the apparent prediction performance ('apparent' performance is the results, when using the same dataset for training as well as for testing the prediction model).
...
other attached packages:
 ...
 [7] ClinicalUtilityRecal_0.1.0 pminternal_0.1.1          
...
loaded via a namespace (and not attached):
 ...
 [46] rstudioapi_0.17.1    dichromat_2.0-0.1    timeDate_4041.110   
 [49] doParallel_1.0.17    codetools_0.2-20     listenv_0.9.1       
 [52] lattice_0.22-6       tibble_3.2.1         plyr_1.8.9          
 [55] GLDEX_2.0.0.9.3      withr_3.0.2          evaluate_1.0.3      
 [58] foreign_0.8-86       future_1.49.0        survival_3.5-8      
 [61] RcppParallel_5.1.10  fitdistrplus_1.2-2   pillar_1.10.2       
 [64] checkmate_2.3.2      foreach_1.5.2        stats4_4.4.0        
 [67] generics_0.1.4       scales_1.4.0         globals_0.18.0      
 [70] class_7.3-22         CalibratR_0.1.2      glue_1.8.0          
 [73] tools_4.4.0          data.table_1.17.2    SparseM_1.84-2      
 [76] ModelMetrics_1.2.2.2 gower_1.0.2          forcats_1.0.0       
 [79] mvtnorm_1.3-3        grid_4.4.0           rbibutils_2.3       
 [82] wesanderson_0.3.7    ipred_0.9-15         colorspace_2.1-1    
 [85] patchwork_1.3.0      nlme_3.1-164         RNGforGPD_1.1.0     
 [88] htmlTable_2.4.3      spacefillr_0.3.3     Formula_1.2-5       
 [91] cli_3.6.5            gp_1.1               lava_1.8.1          
 [94] corpcor_1.6.10       ggcorrplot_0.1.4.1   gtable_0.3.6        
 [97] digest_0.6.37        caret_7.0-1          TH.data_1.1-3       
[100] htmlwidgets_1.6.4    farver_2.1.2         htmltools_0.5.8.1   
[103] lifecycle_1.0.4      hardhat_1.4.1        MASS_7.3-60.2
```
