...
#'
#' Finally, R packages that were used to develop and publish this predictAUDPsyCoLaus R package on GitHub are: devtools, usethis, roxygen2, and Rdpack. Thanks to the many R package developers!
#'
...
#'
#' \insertRef{devtools2021}{predictAUDPsyCoLaus}
#'
#' \insertRef{usethis2021}{predictAUDPsyCoLaus}
#'
